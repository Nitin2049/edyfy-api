...
teacherProfileSchema.methods.isClassTeacher = async function (classId) {
    // Fast path: compare stored classId
    if (this.classId && this.classId.equals(classId))
        return true;
...
teacherProfileSchema.index({ userId: 1 }, { unique: true, partialFilterExpression: { deletedAt: null } });
